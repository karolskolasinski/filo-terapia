...
<header class="z-10 sticky top-0 bg-white md:bg-white/70 md:backdrop-blur-md shadow-md overflow-hidden">
  <div class="flex justify-between items-center p-4 md:px-16 max-w-7xl mx-auto">
    ...
    <nav class="md:hidden group">
      ...
      <ul id="menu-list" class="group-has-checked:right-0 fixed top-0 -right-full w-full h-screen bg-white duration-300 flex flex-col text-xl font-semibold shadow-[inset_0_4px_6px_-1px_rgba(0,0,0,0.1),inset_0_2px_4px_-2px_rgba(0,0,0,0.1)]">
        <li class="border-b border-gray-100">
          <a href="#" class="block w-full py-5 px-6 transition-colors duration-150 active:bg-primary-500 active:text-white select-none">
            Oferta
          </a>
        </li>
        ...
        <li class="mt-auto w-full p-6 flex flex-col gap-5 bg-gray-50/50 border-t border-gray-100">
          <div class="flex flex-col gap-3 text-sm font-medium text-gray-600">
            <div class="inline-flex gap-3 items-center">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" class="w-5 h-5 fill-gray-400">
          ...
          <a href="${prefix}contact" class="button block w-full text-center py-4 text-xl transition-all duration-150 active:bg-primary-500 active:text-white active:scale-[0.98] select-none">
            Skontaktuj się z nami
          </a>
      
          <div class="flex justify-center gap-6 pt-1">
            <a href="https://facebook.com/profile.php?id=1" class="select-none"> 
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" class="w-8 h-8 fill-[#0866ff] active:opacity-80 transition-colors duration-150">
                <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z"/>
              </svg>
            </a>
            
            <a href="https://instagram.com/1" class="select-none"> 
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="min-w-8 h-8 fill-[#E1306C] active:opacity-80 transition-colors duration-150">
