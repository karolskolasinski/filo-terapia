...
>
  <div class="bg-red-500 text-white transition-transform duration-300 translate-y-0"
  >
    <div class="max-w-7xl mx-auto px-4 py-1 md:px-16">
      Gdańsk, Świętokrzyska 64 666 993 383 Pn-Pt 08:00-20:00
    </div>
  </div>
